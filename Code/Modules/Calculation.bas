...
Public Const C_AMOUNT = "Iloœæ"
Public Const C_AMOUNT2 = "Iloœæ do Kosztorysu"
Public Const C_UNITPRICE = "CJ"
Public Const C_SCOPE = "Zakres"
Public Const C_VALUE = "Wartoœæ"
Public Const C_NETVALUE = "Wartoœæ Netto"
Public Const C_COMMENTS = "Uwagi"
Public Const C_TAKEOFF = "Przedmiary"
Public Const C_WORKVALUE = "Wartoœæ prac"
...
'
    ...
    For TabRow = Tab_S.Offset(2, 0).row To ActiveCell.SpecialCells(xlLastCell).row
        ...
        If (Cells(TabRow, T_AREA) <> "" And Cells(TabRow, T_AREA) <> "(puste)" And Cells(TabRow, T_AREA) <> "Suma koñcowa") Then
            Worksheets(A_CALCULATION).Activate
...
'
    ...
    'JEZELI POJAWIA SIÊ TUTAJ BLAD 1004, TO NALEZY ZMIENIC W MENAGERZE NAZW ZAKRES NAZWY Z CENNIKA NA SKOROSZYT (ABY NAZWY ZAKRESOW BYLY WIDOCZNE W INNYCH ARKUSZACH NIZ CENNIKU)
