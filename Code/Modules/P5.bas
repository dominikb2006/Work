...
Public Sub Odwoz_R()
    ...
    cElement.element "R", "ODW", " - wywóz urobku R", "m3", "=" & colT(R_CUT) & "-" & colT(R_FILL), z_zie
End Sub
    
Public Sub Zasyp_R()
    Dim cElement As New C_ElementP5
    cElement.element "R", "ZAS", " - zasyp fundamentów R", "m3", "=" & colT(R_FILL), z_zie
End Sub

Public Sub Zasyp_M()
    Dim cElement As New C_ElementP5
    
    cElement.element "M", "ZAS", " - zasyp fundamentów M", "m3", "=" & colT(R_FILL), z_zie
End Sub
...
Public Sub BET_CHB_Wyrownanie()
    ...
    cElement.element "R", "CHB-W", " - chudy beton R - wyrównanie", "m2", "=" & colT(R_AREA), z_rob
End Sub
...
Public Sub BET_Wyrownanie_R()
    ...
    cElement.element "R", "BET-W-R", " - beton R - wyrównanie z rêki", "m2", "=" & colT(R_AREA), z_rob
End Sub

Public Sub BET_Zatarcie_R()
    Dim cElement As New C_ElementP5
    
    cElement.element "R", "BET-Z-R", " - beton R - zatarcie z rêki", "m2", "=" & colT(R_AREA), z_rob
End Sub

Public Sub BET_Wygladzenie_R()
    Dim cElement As New C_ElementP5
    
    cElement.element "R", "BET-G-R", " - beton R - wyg³adzenie z rêki", "m2", "=" & colT(R_AREA), z_rob
End Sub
...
Public Sub SZA_Strop_K()
    ...
    " - szalunek R - krawêdzie", "m2", "=" & colT(R_FORMWORK2), z_rob
End Sub

Public Sub SZA_Strop_K_D_C()
    Dim cElement As New C_ElementP5

    cElement.element "R", "SZA-K-C", " - krawêdzie - dodatek - czyszczenie", "m2", "=" & colT(R_FORMWORK2), z_rob
End Sub
...
Public Sub SZA_Spocznik_Polaczenie()
    ...
    cElement.element "R", "SZA-P", " - po³¹czenie z deskowaniem schodów", "m2", "=" & colT(R_FORMWORK), z_rob
End Sub

Public Sub SZA_D_H()
    Dim cElement As New C_ElementP5
    
    cElement.element "R", "SZA-H", " - dodatek - wysokoœæ powy¿ej 3,5 m", "kpl.", _
...
Public Sub Szalunek_K()
    ...
    cElement.element "M", "SZA-K", " - szalunek krawêdzi M", "m2", "=" & colT(R_FORMWORK_HEIGHT), z_sza
End Sub
...
Public Sub DOD_Wiercenie()
    ...
    cElement.element "M", "WIER", " - wiercenia i ciêcia", "m3", _
    "=SUMIFS(" & Columns(CalcIndex(C_AMOUNT2)).Address(0, 0) & "," & Columns(CalcIndex(C_MR)).Address(0, 0) & ",""M""," & Columns(CalcIndex(C_MATERIAL)).Address(0, 0) & ",""BET*"")", z_str, _
    "m3 betonu konstrukcyjnego"
End Sub
